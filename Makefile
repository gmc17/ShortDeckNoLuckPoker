...
SRCS = src/main.cpp src/game_state.cpp src/info_set.cpp src/cfr.cpp src/best_response.cpp src/tree.cpp src/tree_cfr.cpp
TEST_SRCS = tests/tests.cpp src/main.cpp src/game_state.cpp src/info_set.cpp src/cfr.cpp src/best_response.cpp src/tree.cpp src/tree_cfr.cpp
MAIN = main
...
$(SHORTDECK): src/main.cpp src/game_state.cpp src/info_set.cpp src/cfr.cpp src/best_response.cpp src/tree.cpp src/tree_cfr.cpp
	$(CXX) $(CXXFLAGS) -o $@ $^ $(LIBS)
